        ...
        switch (viewType) {
            case VIEW_TYPE_TODAY: {
                ...
                viewHolder.iconView.setImageResource(Utility.getArtResourceForWeatherCondition(
                        cursor.getInt(cursor.getColumnIndex(WeatherColumns.WEATHER_ID))));
...
//        String description = cursor.getString(ForecastFragment.COL_WEATHER_DESC);
        ...
        double high = cursor.getDouble(cursor.getColumnIndex(WeatherColumns.MAX_TEMP));
//        double high = cursor.getDouble(ForecastFragment.COL_WEATHER_MAX_TEMP);
        viewHolder.highTempView.setText(Utility.formatTemperature(context, high));

        // Read low temperature from cursor
        double low = cursor.getDouble(cursor.getColumnIndex(WeatherColumns.MIN_TEMP));
